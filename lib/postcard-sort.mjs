...
export function sortPostcards(records, { field, direction, origin = null }) {
  ...
  return [...records].sort((left, right) => {
    ...
    if (field === "rating") {
      ...
      primary = compareNullable(archiveTimestamp(left), archiveTimestamp(right), direction, textCompare);
...
export function archiveTimestamp(record) {
  return record.archived_at ?? record.archived_on ?? null;
}
